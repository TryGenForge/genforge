    ...
    <main style={{ minHeight: "100vh", background: "#080808", color: "#f0f0f0", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <section style={{ maxWidth: "700px", margin: "0 auto", padding: "60px 40px 40px", textAlign: "center" }}>
        ...
        <h1 style={{ fontSize: "42px", fontWeight: 800, lineHeight: 1.1, letterSpacing: "-1px", marginBottom: "16px" }}>
          Brand Voice <span style={{ color: "#7c3aed" }}>Generator</span>
        </h1>
        <p style={{ fontSize: "16px", color: "#888", lineHeight: 1.6, marginBottom: "40px", fontWeight: 300 }}>
          Define your tone of voice and communication style with AI.
        </p>
      </section>
      ...
      {previewResult && !isPro && (
        <section style={{ maxWidth: "600px", margin: "0 auto", padding: "0 40px 20px" }}>
          <div style={{ background: "#0f0f0f", border: "1px solid #1c1c1c", borderRadius: "12px", padding: "20px", marginBottom: "12px" }}>
            ...
            <div style={{ fontSize: "20px", fontWeight: 800, color: "#a78bfa", marginBottom: "12px" }}>{previewResult.tone}</div>
            <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
              {previewResult.adjectives?.slice(0, 2).map((a: string, i: number) => (
                <span key={i} style={{ background: "rgba(124,58,237,0.12)", color: "#a78bfa", border: "1px solid rgba(124,58,237,0.25)", padding: "4px 12px", borderRadius: "20px", fontSize: "12px" }}>{a}</span>
              ))}
            </div>
          </div>
        </section>
      ...
      {/* BLURRED + PAYWALL (non-PRO) */}
      {showPaywall && !isPro && (
        <section style={{ maxWidth: "600px", margin: "0 auto", padding: "0 40px 40px" }}>
          <div style={{ position: "relative" }}>
            <div style={{ filter: "blur(6px)", pointerEvents: "none", display: "flex", flexDirection: "column", gap: "10px" }}>
              {["Do's and Don'ts for your brand", "3 example sentences in your tone", "Full adjective palette"].map((t, i) => (
            ...
            <div style={{
              ...
              <div style={{
                ...
                <h3 style={{ fontSize: "20px", fontWeight: 800, marginBottom: "8px" }}>Unlock full brand voice guide</h3>
        ...
        <section style={{ maxWidth: "600px", margin: "0 auto", padding: "0 40px 80px" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <div style={{ background: "#0f0f0f", border: "1px solid #1c1c1c", borderRadius: "12px", padding: "24px" }}>
              ...
              <div style={{ fontSize: "22px", fontWeight: 800, color: "#a78bfa" }}>{fullResult.tone}</div>
            </div>
            <div style={{ background: "#0f0f0f", border: "1px solid #1c1c1c", borderRadius: "12px", padding: "24px" }}>
              <div style={{ fontSize: "11px", color: "#444", letterSpacing: "2px", textTransform: "uppercase", marginBottom: "12px" }}>Brand Adjectives</div>
              <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
                {fullResult.adjectives?.map((a: string, i: number) => (
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
              <div style={{ background: "#0f0f0f", border: "1px solid #1c1c1c", borderRadius: "12px", padding: "24px" }}>
                ...
                {fullResult.dos?.map((d: string, i: number) => (
              ...
              <div style={{ background: "#0f0f0f", border: "1px solid #1c1c1c", borderRadius: "12px", padding: "24px" }}>
                ...
                {fullResult.donts?.map((d: string, i: number) => (
            ...
            <div style={{ background: "#0f0f0f", border: "1px solid #1c1c1c", borderRadius: "12px", padding: "24px" }}>
              ...
              {fullResult.examples?.map((e: string, i: number) => (
